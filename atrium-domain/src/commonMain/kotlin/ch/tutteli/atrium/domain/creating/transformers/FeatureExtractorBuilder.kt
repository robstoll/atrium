...
import ch.tutteli.atrium.domain.creating.transformers.impl.featureextractor.*
...
interface FeatureExtractorBuilder {
    ...
    interface DescriptionStep<SubjectT> {
        ...
        /**
         * Uses the given [inlineElement] as description of the feature.
         */
        fun withDescription(inlineElement: InlineElement): RepresentationInCaseOfFailureStep<SubjectT>
    ...
    interface ExecutionStep<SubjectT, FeatureT> : TransformationExecutionStep<SubjectT, FeatureT, FeatureExpect<SubjectT, FeatureT>> {
        ...
        companion object {
            ...
            operator fun <SubjectT, FeatureT> invoke(
                ...
                actionAndApply: (ProofContainer<SubjectT>, Expect<FeatureT>.() -> Unit) -> Expect<FeatureT>
