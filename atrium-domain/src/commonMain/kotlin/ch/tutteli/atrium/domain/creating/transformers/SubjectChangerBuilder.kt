...
import ch.tutteli.atrium.domain.creating.transformers.impl.subjectchanger.*
import ch.tutteli.atrium.domain.reporting.descriptions.DescriptionAnyExpectation
    ...
    interface ExecutionStep<SubjectT, SubjectAfterChangeT> :
        ...
        companion object {
            ...
            operator fun <SubjectT, SubjectAfterChangeT> invoke(
                ...
                actionAndApply: (ProofContainer<SubjectT>, Expect<SubjectAfterChangeT>.() -> Unit) -> Expect<SubjectAfterChangeT>
