package ch.tutteli.atrium.domain.creating.transformers.impl.featureextractor
...
class FinalStepImpl<SubjectT, FeatureT>(
    ...
    private fun extractIt(container: ProofContainer<SubjectT>, maybeSubAssertions: Option<Expect<FeatureT>.() -> Unit>): FeatureExpect<SubjectT, FeatureT> =
