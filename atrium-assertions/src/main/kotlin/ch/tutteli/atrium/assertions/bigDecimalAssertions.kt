...
private fun <T : BigDecimal> isEqualIncludingScale(plant: AssertionPlant<T>, expected: T)
    = BasicDescriptiveAssertion(IS_EQUAL_INCLUDING_SCALE, expected, { plant.subject == expected })
...
fun <T : BigDecimal> _isNotEqualIncludingScale(plant: AssertionPlant<T>, expected: T)
    ...
    = BasicDescriptiveAssertion(IS_NOT_EQUAL_INCLUDING_SCALE, expected, { plant.subject != expected })
