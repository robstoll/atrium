 ...
 */
abstract class CharSequenceContainsNotOrAtMostCheckerBuilderBase<T : CharSequence, D : CharSequenceContainsAssertionCreator.IDecorator>(
    val times: Int,
    ...
    override val checkers: List<CharSequenceContainsAssertionCreator.IChecker> = listOf(
