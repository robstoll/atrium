 ...
 */
@Deprecated("use the fun from package creating, will be removed with 1.0.0", ReplaceWith("ch.tutteli.atrium.creating.basic.contains.builders.validateAtMost"))
fun validateAtMost(
    times: Int,
 ...
 */
@Deprecated("use the fun from package creating, will be removed with 1.0.0", ReplaceWith("ch.tutteli.atrium.creating.basic.contains.builders.validateButAtMost"))
