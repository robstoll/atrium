...
object AssertionCollector {
    ...
    class Collector(private val throwIfNoAssertionIsCollected: Boolean) {
         ...
         *
         * @throws IllegalArgumentException Might throw an [IllegalArgumentException] in case the [createAssertions]
         ...
         */
        fun <E : Any> collectAssertionsForExplanation(noSubjectMessage: String, warning: ITranslatable, createAssertions: IAssertionPlant<E>.() -> Unit, subject: E?): List<IAssertion> {
            return try {
