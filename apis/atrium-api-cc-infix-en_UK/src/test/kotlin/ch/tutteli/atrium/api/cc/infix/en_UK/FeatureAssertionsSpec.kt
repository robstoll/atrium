...
class FeatureAssertionsSpec : ch.tutteli.atrium.spec.integration.FeatureAssertionsSpec(
    ...
    companion object {
        ...
        val return1ValueImmediate: F = { returnValueOf1({ subject::return1 }, "a") contains Values("hello") }
        val return2ValueImmediate: F = { returnValueOf2({ subject::return2 }, "a", 1) contains Values("hello") }
        val return3ValueImmediate: F = { returnValueOf3({ subject::return3 }, "a", 1, true) contains Values("hello") }
        val return4ValueImmediate: F = { returnValueOf4({ subject::return4 }, "a", 1, true, 1.2) contains Values("hello") }
        val return5ValueImmediate: F = { returnValueOf5({ subject::return5 }, "a", 1, true, 1.2, 'b') contains Values("hello") }
        val return0ValueLazy: F = { returnValueOf({ subject::return0 } ) { this contains Values("hello") } }
        val return1ValueLazy: F = { returnValueOf1({ subject::return1 }, "a" ) { this contains Values("hello") } }
        val return2ValueLazy: F = { returnValueOf2({ subject::return2 }, "a", 1 ) { this contains Values("hello") } }
        val return3ValueLazy: F = { returnValueOf3({ subject::return3 }, "a", 1, true ) { this contains Values("hello") } }
        val return4ValueLazy: F = { returnValueOf4({ subject::return4 }, "a", 1, true, 1.2 ) { this contains Values("hello") } }
        val return5ValueLazy: F = { returnValueOf5({ subject::return5 }, "a", 1, true, 1.2, 'b' ) { this contains Values("hello") } }
