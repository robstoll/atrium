...
class CharSequenceContainsDefaultTranslationOfAssertionsSpec : ch.tutteli.atrium.spec.assertions.CharSequenceContainsDefaultTranslationAssertionSpec(
    ...
    companion object : CharSequenceContainsSpecBase() {
        ...
        private fun containsAtLeast(plant: IAssertionPlant<CharSequence>, atLeast: Int, a: Translatable, aX: Array<out Translatable>): IAssertionPlant<CharSequence> {
        ...
        private fun containsAtMostIgnoringCase(plant: IAssertionPlant<CharSequence>, atMost: Int, a: Translatable, aX: Array<out Translatable>): IAssertionPlant<CharSequence> {
            return if (aX.isEmpty()) {
