...
@Deprecated(
    ...
    ReplaceWith("ch.tutteli.atrium.api.cc.infix.en_UK.creating.iterable.contains.builders.IterableContainsNotOrAtMostCheckerBuilder")
)
...
) : ch.tutteli.atrium.api.cc.infix.en_UK.creating.iterable.contains.builders.NotOrAtMostCheckerBuilderImpl<E, T, IterableContainsInAnyOrderSearchBehaviour>(
