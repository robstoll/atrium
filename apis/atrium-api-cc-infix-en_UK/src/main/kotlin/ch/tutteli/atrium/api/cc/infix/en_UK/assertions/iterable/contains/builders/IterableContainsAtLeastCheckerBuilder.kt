...
@Deprecated(
    ...
    ReplaceWith("ch.tutteli.atrium.api.cc.infix.en_UK.creating.iterable.contains.builders.IterableContainsAtLeastCheckerBuilder")
)
...
) : ch.tutteli.atrium.api.cc.infix.en_UK.creating.iterable.contains.builders.IterableContainsAtLeastCheckerBuilder<E, T, IterableContainsInAnyOrderSearchBehaviour>(
