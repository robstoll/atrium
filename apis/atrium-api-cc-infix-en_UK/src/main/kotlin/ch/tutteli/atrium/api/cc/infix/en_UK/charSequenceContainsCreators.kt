 ...
 */
infix fun <T : CharSequence> CharSequenceContains.CheckerBuilder<T, NoOpSearchBehaviour>.value(expected: Any): AssertionPlant<T>
 ...
 */
infix fun <T : CharSequence> CharSequenceContains.CheckerBuilder<T, NoOpSearchBehaviour>.the(values: Values<Any>): AssertionPlant<T>
...
infix fun <T : CharSequence> CharSequenceContains.CheckerBuilder<T, IgnoringCaseSearchBehaviour>.value(expected: Any): AssertionPlant<T>
    = this the Values(expected)
...
infix fun <T : CharSequence> CharSequenceContains.CheckerBuilder<T, IgnoringCaseSearchBehaviour>.the(values: Values<Any>): AssertionPlant<T>
 ...
 * @throws AssertionError Might throw an [AssertionError] if the assertion made is not correct.
 */
infix fun <T : CharSequence> CharSequenceContains.CheckerBuilder<T, NoOpSearchBehaviour>.defaultTranslationOf(translatable: Translatable): AssertionPlant<T>
 ...
 * @throws AssertionError Might throw an [AssertionError] if the assertion made is not correct.
 */
infix fun <T : CharSequence> CharSequenceContains.CheckerBuilder<T, NoOpSearchBehaviour>.the(translatables: DefaultTranslationsOf): AssertionPlant<T>
...
infix fun <T : CharSequence> CharSequenceContains.CheckerBuilder<T, IgnoringCaseSearchBehaviour>.defaultTranslationOf(translatable: Translatable): AssertionPlant<T>
    = this the DefaultTranslationsOf(translatable)
...
infix fun <T : CharSequence> CharSequenceContains.CheckerBuilder<T, IgnoringCaseSearchBehaviour>.the(translatables: DefaultTranslationsOf): AssertionPlant<T>
 ...
 * @throws AssertionError Might throw an [AssertionError] if the assertion made is not correct.
 */
infix fun <T : CharSequence> CharSequenceContains.CheckerBuilder<T, NoOpSearchBehaviour>.regex(pattern: String): AssertionPlant<T>
 ...
 * @throws AssertionError Might throw an [AssertionError] if the assertion made is not correct.
 */
infix fun <T : CharSequence> CharSequenceContains.CheckerBuilder<T, NoOpSearchBehaviour>.the(patterns: RegexPatterns): AssertionPlant<T>
...
infix fun <T : CharSequence> CharSequenceContains.CheckerBuilder<T, IgnoringCaseSearchBehaviour>.regex(pattern: String): AssertionPlant<T>
    = this the RegexPatterns(pattern)
 ...
 */
@JvmName("regexIgnoringCase")
infix fun <T : CharSequence> CharSequenceContains.CheckerBuilder<T, IgnoringCaseSearchBehaviour>.the(patterns: RegexPatterns): AssertionPlant<T>
