...
@Deprecated(
    ...
    ReplaceWith("ch.tutteli.atrium.api.cc.de_CH.creating.iterable.contains.builders.IterableContainsAtMostCheckerBuilder")
)
...
) : ch.tutteli.atrium.api.cc.de_CH.creating.iterable.contains.builders.IterableContainsAtMostCheckerBuilder<E, T, IterableContainsInAnyOrderSearchBehaviour>(
