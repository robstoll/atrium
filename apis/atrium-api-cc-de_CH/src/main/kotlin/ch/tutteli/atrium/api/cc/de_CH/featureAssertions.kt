...
/**
 * Creates an [AssertionPlant] for the given [property] which eventually adds [IAssertionGroup]s with a
...
/**
 * Creates an [AssertionPlantNullable] for the given [property] which eventually adds [IAssertionGroup]s with a
 * [IFeatureAssertionGroupType], containing the assertions created for the given [property], to the current plant.
 *
...
/**
 * Creates an [AssertionPlant], for the value returned by calling [method], which eventually adds [IAssertionGroup]s
