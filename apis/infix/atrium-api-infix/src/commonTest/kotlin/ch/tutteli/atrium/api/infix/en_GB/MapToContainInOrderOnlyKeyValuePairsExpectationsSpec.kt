...
class MapToContainInOrderOnlyKeyValuePairsExpectationsSpec : Spek({
    ...
    companion object : MapToContainSpecBase() {
        ...
        private fun toContainKeyValuePairs(
            ...
            } else expect toContain o inGiven order and only the pairs(a, *aX, reportOptionsInOrderOnly = report)
    ...
    private fun ambiguityTest() {
        ...
        map = map toContain o inGiven order and only the pairs(1 to "a", reportOptionsInOrderOnly = {})
        subMap = subMap toContain o inGiven order and only the pairs(1 to "a", reportOptionsInOrderOnly = {})
        nKeyMap = nKeyMap toContain o inGiven order and only the pairs(1 to "a", reportOptionsInOrderOnly = {})
        nValueMap = nValueMap toContain o inGiven order and only the pairs(1 to "a", reportOptionsInOrderOnly = {})
        nKeyValueMap =
            nKeyValueMap toContain o inGiven order and only the pairs(1 to "a", reportOptionsInOrderOnly = {})
        ronKeyValueMap =
            ronKeyValueMap toContain o inGiven order and only the pairs(1 to "a", reportOptionsInOrderOnly = {})
        starMap = starMap toContain o inGiven order and only the pairs(1 to "a", reportOptionsInOrderOnly = {})
        ...
        ronKeyValueMap =
            ronKeyValueMap toContain o inGiven order and only the pairs((null to "a"), null to null, 1 to null)
        ...
        nValueMap = nValueMap toContain o inGiven order and only the pairs(
            1 to null, reportOptionsInOrderOnly = {}
        )
        nKeyValueMap = nKeyValueMap toContain o inGiven order and only the pairs(
            (null to "a"),
            null to null,
