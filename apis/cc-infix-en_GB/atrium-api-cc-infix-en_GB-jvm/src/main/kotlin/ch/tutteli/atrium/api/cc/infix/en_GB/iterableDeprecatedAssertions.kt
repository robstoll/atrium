...
@Deprecated("Use `contains` instead; will be removed with 1.0.0", ReplaceWith("this contains nullableValue.expected"))
infix fun <E : Any?, T : Iterable<E>> Assert<T>.contains(nullableValue: NullableValue<E>)
    = this contains nullableValue.expected

@Deprecated("Use `contains` instead; will be removed with 1.0.0", ReplaceWith("this contains Values(nullableValues.expected, *nullableValues.otherExpected)"))
...
@Deprecated("Use `contains` instead; will be removed with 1.0.0", ReplaceWith("this contains nullableEntry.assertionCreator"))
...
@Deprecated("Use `contains` instead; will be removed with 1.0.0", ReplaceWith("this contains Entries(nullableEntries.assertionCreatorOrNull, *nullableEntries.otherAssertionCreatorsOrNulls)"))
...
@Deprecated("Use `any` instead; will be removed with 1.0.0", ReplaceWith("this any nullableEntry.assertionCreator"))
...
@Deprecated("Use `none` instead; will be removed with 1.0.0", ReplaceWith("this none nullableEntry.assertionCreator"))
