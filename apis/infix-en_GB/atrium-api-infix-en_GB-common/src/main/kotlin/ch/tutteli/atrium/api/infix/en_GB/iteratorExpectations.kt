 ...
 * @since 0.13.0
 *
 * @sample ch.tutteli.atrium.api.infix.en_GB.samples.IteratorExpectationsSamples.has
 */
 ...
 * @since 0.13.0
 *
 * @sample ch.tutteli.atrium.api.infix.en_GB.samples.IteratorExpectationsSamples.hasNot
 */
