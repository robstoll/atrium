 ...
 */
fun <T> Assert<T>.isLessThan(expected: T) where T : Number, T : Comparable<T>
 ...
 * @throws AssertionError Might throw an [AssertionError] if the assertion made is not correct.
 */
fun <T> Assert<T>.isLessOrEquals(expected: T) where T : Number, T : Comparable<T>
 ...
 * @throws AssertionError Might throw an [AssertionError] if the assertion made is not correct.
 */
fun <T> Assert<T>.isGreaterThan(expected: T) where T : Number, T : Comparable<T>
 ...
 * @throws AssertionError Might throw an [AssertionError] if the assertion made is not correct.
 */
fun <T> Assert<T>.isGreaterOrEquals(expected: T) where T : Number, T : Comparable<T>
