...
class CharSequenceToContainNotToContainExpectationsTest : Spek({

    include(object : ch.tutteli.atrium.specs.integration.AbstractCharSequenceToContainNotToContainExpectationsTest(
        getToContainPair(),
        getNotToContainPair(),
        "[Atrium][Builder]"
    ) {})
