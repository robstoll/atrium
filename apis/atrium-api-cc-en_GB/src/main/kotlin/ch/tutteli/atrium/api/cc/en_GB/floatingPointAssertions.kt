...
/**
 * Makes the assertion that [Assert.subject] is equal to [expected] with an error [tolerance]
 * (range including bounds).
 *
 * It effectively compares the absolute difference between [Assert.subject] and [expected] and compares it with
 ...
 *
 * | [Assert.subject] - [expected] | ≤ [tolerance]
 *
