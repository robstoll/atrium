...
class CharSequenceContainsRegexAssertionsSpec : Spek({
    ...
    object StringSpec : ch.tutteli.atrium.specs.integration.CharSequenceContainsRegexAssertionsSpecString(
    ...
    object RegexSpec : ch.tutteli.atrium.specs.integration.CharSequenceContainsRegexAssertionsSpecRegex(
        getNameContainsRegex(),
