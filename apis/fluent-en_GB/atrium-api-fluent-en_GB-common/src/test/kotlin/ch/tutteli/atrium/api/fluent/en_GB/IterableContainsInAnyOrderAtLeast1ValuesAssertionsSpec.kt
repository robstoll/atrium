...
class IterableContainsInAnyOrderAtLeast1ValuesAssertionsSpec : Spek({
    ...
    companion object : IterableContainsSpecBase() {
        ...
        private fun containsValues(plant: Expect<Iterable<Double>>, a: Double, aX: Array<out Double>): Expect<Iterable<Double>> {
        ...
        private fun containsNullableValues(plant: Expect<Iterable<Double?>>, a: Double?, aX: Array<out Double?>): Expect<Iterable<Double?>> {
            return if (aX.isEmpty()) {
                plant.contains.inAnyOrder.atLeast(1).value(a)
            } else {
                plant.contains.inAnyOrder.atLeast(1).values(a, *aX)
        ...
        private val containsFun: KFunction3<Expect<Iterable<Double>>, Double, Array<out Double>, Expect<Iterable<Double>>> = Expect<Iterable<Double>>::contains
        fun getContainsShortcutPair() = containsFun.name to Companion::containsValuesShortcut

        private fun containsValuesShortcut(plant: Expect<Iterable<Double>>, a: Double, aX: Array<out Double>): Expect<Iterable<Double>> {
            return if (aX.isEmpty()) {
                plant.contains(a)
            } else {
                plant.contains(a, *aX)
        ...
        private val containsNullableFun: KFunction3<Expect<Iterable<Double?>>, Double, Array<out Double?>, Expect<Iterable<Double?>>> = Expect<Iterable<Double?>>::contains
        fun getContainsNullableShortcutPair() = containsNullableFun.name to Companion::containsNullableValuesShortcut

        private fun containsNullableValuesShortcut(plant: Expect<Iterable<Double?>>, a: Double?, aX: Array<out Double?>): Expect<Iterable<Double?>> {
            return if (aX.isEmpty()) {
                plant.contains(a)
            } else {
                plant.contains(a, *aX)
