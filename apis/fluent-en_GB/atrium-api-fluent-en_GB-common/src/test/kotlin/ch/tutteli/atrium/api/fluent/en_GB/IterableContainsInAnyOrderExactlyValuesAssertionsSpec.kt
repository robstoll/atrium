...
class IterableContainsInAnyOrderExactlyValuesAssertionsSpec : ch.tutteli.atrium.specs.integration.IterableContainsInAnyOrderExactlyValuesAssertionsSpec(
    ...
    companion object : IterableContainsSpecBase() {
        ...
        private fun containsExactly(plant: Expect<Iterable<Double>>, exactly: Int, a: Double, aX: Array<out Double>): Expect<Iterable<Double>> {
            return if (aX.isEmpty()) {
                ...
                plant.contains.inAnyOrder.exactly(exactly).values(a, *aX)
            }
        }
