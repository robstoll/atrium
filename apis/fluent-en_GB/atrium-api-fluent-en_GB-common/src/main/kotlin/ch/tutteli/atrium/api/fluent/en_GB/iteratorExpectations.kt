 ...
 * @since 0.13.0
 *
 * @sample ch.tutteli.atrium.api.fluent.en_GB.samples.IteratorExpectationsSamples.hasNext
 */
 ...
 * @since 0.13.0
 *
 * @sample ch.tutteli.atrium.api.fluent.en_GB.samples.IteratorExpectationsSamples.hasNoNext
 */
