 ...
 *
 * @sample ch.tutteli.atrium.api.fluent.en_GB.samples.ComparableExpectationsSamples.isLessThan
 */
 ...
 * @return An [Expect] for the current subject of the assertion.
 *
 * @sample ch.tutteli.atrium.api.fluent.en_GB.samples.ComparableExpectationsSamples.isLessThanOrEqual
 */
 ...
 * @return An [Expect] for the current subject of the assertion.
 *
 * @sample ch.tutteli.atrium.api.fluent.en_GB.samples.ComparableExpectationsSamples.isGreaterThan
 */
 ...
 * @return An [Expect] for the current subject of the assertion.
 *
 * @sample ch.tutteli.atrium.api.fluent.en_GB.samples.ComparableExpectationsSamples.isGreaterThanOrEqual
 */
 ...
 * @since 0.13.0
 *
 * @sample ch.tutteli.atrium.api.fluent.en_GB.samples.ComparableExpectationsSamples.isEqualComparingTo
 */
