 ...
 *
 * @sample ch.tutteli.atrium.api.fluent.en_GB.samples.CollectionExpectationsSamples.isEmpty
 */
 ...
 * @return An [Expect] for the current subject of the assertion.
 *
 * @sample ch.tutteli.atrium.api.fluent.en_GB.samples.CollectionExpectationsSamples.isNotEmpty
 */
 ...
 * @return An [Expect] for the current subject of the assertion.
 *
 * @sample ch.tutteli.atrium.api.fluent.en_GB.samples.CollectionExpectationsSamples.hasSize
 */
 ...
 *
 * @sample ch.tutteli.atrium.api.fluent.en_GB.samples.CollectionExpectationsSamples.sizeFeature
 */
 ...
 * @return An [Expect] for the current subject of the assertion.
 *
 * @sample ch.tutteli.atrium.api.fluent.en_GB.samples.CollectionExpectationsSamples.size
 */
