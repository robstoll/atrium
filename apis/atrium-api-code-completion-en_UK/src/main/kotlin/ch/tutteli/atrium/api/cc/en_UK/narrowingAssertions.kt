 ...
 */
inline fun <reified T : Any> IAssertionPlantNullable<T?>.isNotNull(noinline assertionCreator: IAssertionPlant<T>.() -> Unit) {
 ...
 * @throws AssertionError Might throw an [AssertionError] if the assertion made is not correct.
 */
inline fun <reified TSub : Any> IAssertionPlant<Any>.isA(noinline assertionCreator: IAssertionPlant<TSub>.() -> Unit) {
