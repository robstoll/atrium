 ...
 */
actual fun Assert<Float>.istMitFehlerToleranz(expected: Float, tolerance: Float)
 ...
 * @throws AssertionError Might throw an [AssertionError] if the assertion made is not correct.
 */
actual fun Assert<Double>.istMitFehlerToleranz(expected: Double, tolerance: Double)
    = addAssertion(AssertImpl.floatingPoint.toBeWithErrorTolerance(this, expected, tolerance))
