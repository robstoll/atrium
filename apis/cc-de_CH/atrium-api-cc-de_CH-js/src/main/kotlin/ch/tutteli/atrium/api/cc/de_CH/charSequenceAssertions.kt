 ...
 */
actual val <T : CharSequence> Assert<T>.enthaelt: CharSequenceContains.Builder<T, NoOpSearchBehaviour>
 ...
 * @return The newly created builder.
 */
actual val <T : CharSequence> Assert<T>.enthaeltNicht: NotCheckerOption<T, NotSearchBehaviour>
 ...
 */
actual fun <T : CharSequence> Assert<T>.enthaelt(expected: Any, vararg otherExpected: Any)
 ...
 * @throws AssertionError Might throw an [AssertionError] if the assertion made is not correct.
 */
actual fun <T : CharSequence> Assert<T>.enthaeltNicht(expected: Any, vararg otherExpected: Any)
 ...
 * @throws AssertionError Might throw an [AssertionError] if the assertion made is not correct.
 */
actual fun <T : CharSequence> Assert<T>.enthaeltRegex(
    pattern: String,
 ...
 * @throws AssertionError Might throw an [AssertionError] if the assertion made is not correct.
 */
actual fun <T : CharSequence> Assert<T>.beginntMit(expected: CharSequence)
 ...
 * @throws AssertionError Might throw an [AssertionError] if the assertion made is not correct.
 */
actual fun <T : CharSequence> Assert<T>.beginntNichtMit(expected: CharSequence)
 ...
 * @throws AssertionError Might throw an [AssertionError] if the assertion made is not correct.
 */
actual fun <T : CharSequence> Assert<T>.endetMit(expected: CharSequence)
 ...
 * @throws AssertionError Might throw an [AssertionError] if the assertion made is not correct.
 */
actual fun <T : CharSequence> Assert<T>.endetNichtMit(expected: CharSequence)
 ...
 * @throws AssertionError Might throw an [AssertionError] if the assertion made is not correct.
 */
actual fun <T : CharSequence> Assert<T>.istLeer()
 ...
 * @throws AssertionError Might throw an [AssertionError] if the assertion made is not correct.
 */
actual fun <T : CharSequence> Assert<T>.istNichtLeer()
