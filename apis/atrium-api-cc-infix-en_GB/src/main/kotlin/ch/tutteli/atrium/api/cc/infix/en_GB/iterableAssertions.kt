 ...
 * in case [nullableEntries].[assertionCreator][NullableEntries.assertionCreator] is defined as `null` as well --
 ...
 * [nullableEntry] is defined as `null`.
 *
 ...
 * single entry which is `null` in case [nullableEntry] is defined as `null`.
 *
