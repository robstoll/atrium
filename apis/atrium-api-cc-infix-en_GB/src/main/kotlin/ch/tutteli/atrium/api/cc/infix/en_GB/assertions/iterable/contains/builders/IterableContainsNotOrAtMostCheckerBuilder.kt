package ch.tutteli.atrium.api.cc.infix.en_GB.assertions.iterable.contains.builders
...
) : ch.tutteli.atrium.api.cc.infix.en_GB.creating.iterable.contains.builders.NotOrAtMostCheckerOptionImpl<E, T, InAnyOrderSearchBehaviour>(
