...
class MapAssertionsSpec : ch.tutteli.atrium.spec.integration.MapAssertionsSpec(
    ...
    companion object {
        ...
        private val containsKeyWithNullableValueAssertionsFun : KFunction3<Assert<Map<out String?, Int?>>, KeyNullableValue<String?, Int>, Array<out KeyNullableValue<String?, Int>>, Assert<Map<out String?, Int?>>> = Assert<Map<out String?, Int?>>::contains
