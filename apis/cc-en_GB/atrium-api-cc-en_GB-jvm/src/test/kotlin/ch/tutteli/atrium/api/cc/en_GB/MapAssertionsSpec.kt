...
class MapAssertionsSpec : ch.tutteli.atrium.spec.integration.MapAssertionsSpec(
    ...
    containsNullableFun.name to Assert<Map<out String?, Int?>>::containsNullable,
    ...
    "${Assert<Map<out String?, *>>::containsKey.name} for nullable" to Assert<Map<out String?, *>>::containsKey,
    Assert<Map<out String, *>>::containsKey.name to Assert<Map<out String, *>>::containsNotKey,
    "${Assert<Map<out String?, *>>::containsKey.name} for nullable" to Assert<Map<out String?, *>>::containsNotKey,
    ...
    companion object {
        ...
        private val containsNullableFun : KFunction3<Assert<Map<out String?, Int?>>, Pair<String?, Int?>, Array<out Pair<String?, Int?>>, Assert<Map<out String?, Int?>>> = Assert<Map<out String?, Int?>>::containsNullable
        ...
        private val containsKeyWithNullableValueAssertionsFun : KFunction3<Assert<Map<out String?, Int?>>, KeyNullableValue<String?, Int>, Array<out KeyNullableValue<String?, Int>>, Assert<Map<out String?, Int?>>> = Assert<Map<out String?, Int?>>::containsNullable
