...
- [atrium-cc-de_CH-robstoll](https://robstoll.github.io/atrium/0.5.0/doc/ch.tutteli.atrium.api.cc.de_-c-h/index.html)
- [atrium-cc-en_UK-robstoll](https://robstoll.github.io/atrium/0.5.0/doc/ch.tutteli.atrium.api.cc.en_-u-k/index.html)
- [atrium-cc-infix-en_UK-robstoll](https://robstoll.github.io/atrium/0.5.0/doc/ch.tutteli.atrium.api.cc.infix.en_-u-k/index.html)

----

Following an excerpt of a build.gradle file which uses two APIs (see 
[README#Installation](https://github.com/robstoll/atrium/tree/v0.5.0/README.md#installation)
for the rest):
```
dependencies {
