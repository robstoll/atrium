...
- [atrium-fluent-en_GB](https://robstoll.github.io/atrium/0.11.0/doc/ch.tutteli.atrium.api.fluent.en_-g-b/index.html)
- [atrium-infix-en_GB](https://robstoll.github.io/atrium/0.11.0/doc/ch.tutteli.atrium.api.infix.en_-g-b/index.html)

----

Following an excerpt of a build.gradle file which uses twit APIs (see 
[README#Installation](https://github.com/robstoll/atrium/tree/v0.11.0/README.md#installation)
for the rest):
```
dependencies {
