...
//     */
//    protected abstract val descriptionNumberOfElementsFound: Description
    ...
    protected abstract fun searchAndCreateProof(
        ...
        featureFactory: (container: ProofContainer<SubjectMultiConsumableT>, numberOfOccurrences: Int, description: Description) -> ProofGroup
    ): ProofGroup
