...
interface ToContain {
     ...
     */
    interface CheckerStepLogic<SubjectT : Any, out SearchBehaviourT : SearchBehaviour, out CheckerT : Checker, out EntryPointStepT : EntryPointStepCore<SubjectT, SearchBehaviourT>> {
        /**
         ...
         */
        val entryPointStepLogic: EntryPointStepT
