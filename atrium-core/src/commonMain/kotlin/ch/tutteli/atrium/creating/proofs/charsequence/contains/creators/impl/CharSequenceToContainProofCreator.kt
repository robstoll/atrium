...
) : ToContainObjectsProofCreator<SubjectT, String, SearchCriteriaT, SearchBehaviourT, Checker>(searchBehaviour, checkers), Creator<SubjectT, SearchCriteriaT> {

    override val descriptionToContain: Description =
        DescriptionCharSequenceProof.TO_CONTAIN

    override val descriptionNumberOfOccurrences: Description =
        DescriptionCharSequenceProof.NUMBER_OF_MATCHES

    override val descriptionNotFound: Description =
        DescriptionCharSequenceProof.NOT_FOUND
