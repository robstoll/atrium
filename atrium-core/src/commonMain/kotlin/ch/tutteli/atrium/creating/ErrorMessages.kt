 ...
 */
@Deprecated(
    "switch to ch.tutteli.atrium.reporting.reportables.ErrorMessages, will be removed with 2.0.0 at the latest",
...
enum class ErrorMessages(override val value: String) : StringBasedTranslatable {
    ...
    @Deprecated(
        ...
        ReplaceWith("ch.tutteli.atrium.reporting.reportables.ErrorMessages.AT_LEAST_ONE_EXPECTATION_DEFINED")
    )
    /** @since 0.18.0 */
