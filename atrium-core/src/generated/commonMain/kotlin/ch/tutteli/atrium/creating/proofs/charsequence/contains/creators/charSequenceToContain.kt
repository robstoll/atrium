...
fun <T : CharSequence> CharSequenceToContain.CheckerStepCore<T, NoOpSearchBehaviour>.values(expected: List<CharSequenceOrNumberOrChar>): ProofGroup = impl.values(this, expected)

fun <T : CharSequence> CharSequenceToContain.CheckerStepCore<T, IgnoringCaseSearchBehaviour>.valuesIgnoringCase(expected: List<CharSequenceOrNumberOrChar>): ProofGroup = impl.valuesIgnoringCase(this, expected)

fun <T : CharSequence> CharSequenceToContain.CheckerStepCore<T, NoOpSearchBehaviour>.regex(expected: List<Regex>): ProofGroup = impl.regex(this, expected)

fun <T : CharSequence> CharSequenceToContain.CheckerStepCore<T, IgnoringCaseSearchBehaviour>.regexIgnoringCase(expected: List<String>): ProofGroup = impl.regexIgnoringCase(this, expected)
