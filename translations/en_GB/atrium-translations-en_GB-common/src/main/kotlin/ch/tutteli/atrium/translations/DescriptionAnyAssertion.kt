...
enum class DescriptionAnyAssertion(override val value: String) : StringBasedTranslatable {
    @Deprecated("Will be removed in version 1.0.0.", ReplaceWith("DescriptionBasic.TO_BE", imports = ["ch.tutteli.atrium.translations.DescriptionBasic"]))
    TO_BE(DescriptionBasic.TO_BE.value),
    @Deprecated("Will be removed in version 1.0.0.", ReplaceWith("DescriptionBasic.NOT_TO_BE", imports = ["ch.tutteli.atrium.translations.DescriptionBasic"]))
