...
enum class DescriptionMapAssertion(override val value: String) : StringBasedTranslatable {
    ...
    @Deprecated(
        "Use DescriptionMapLikeAssertion.CONTAINS_KEY; will be removed with 0.16.0",
        ReplaceWith("DescriptionMapLikeAssertion.CONTAINS_KEY")
    )
    CONTAINS_KEY("enthält Key"),

    @Deprecated(
        "Use DescriptionMapLikeAssertion.CONTAINS_NOT_KEY; will be removed with 0.16.0",
        ReplaceWith("DescriptionMapLikeAssertion.CONTAINS_NOT_KEY")
    )
    CONTAINS_NOT_KEY("enthält nicht den Key"),

    @Deprecated(
        "Use DescriptionMapLikeAssertion.ENTRY_WITH_KEY; will be removed with 0.16.0",
        ReplaceWith("DescriptionMapLikeAssertion.ENTRY_WITH_KEY")
    )
    ENTRY_WITH_KEY("Eintrag %s"),

    @Deprecated(
        "Use DescriptionMapLikeAssertion.KEY_DOES_NOT_EXIST; will be removed with 0.16.0",
