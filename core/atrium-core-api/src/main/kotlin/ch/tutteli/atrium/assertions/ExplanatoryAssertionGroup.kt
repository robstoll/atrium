...
/**
 * Represents an [IAssertionGroup] with an [ExplanatoryAssertionGroupType], which means an [Reporter] should not
 * show whether the [assertions] hold or not -- moreover [holds] always returns `true`.
 *
 * @constructor Represents an [IAssertionGroup] with an [ExplanatoryAssertionGroupType], which means an [Reporter]
