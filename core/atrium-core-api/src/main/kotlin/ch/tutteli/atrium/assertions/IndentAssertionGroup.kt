...
/**
 * Represents an [AssertionGroup] with an [IIndentAssertionGroupType], which means the [assertions] shall be
 * indented one extra level and [name] and [subject] shall be neglected (not reported to the output).
 *
 * @constructor Represents an [AssertionGroup] with an [IIndentAssertionGroupType], which means the [assertions] shall
