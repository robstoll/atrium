 ...
 **/
@Deprecated("Use something like ch.tutteli.atrium.core.Option instead; will be removed with 0.10.0")
sealed class MaybeSubject<out T> {
    ...
    @Deprecated("Use something like ch.tutteli.atrium.core.None instead; will be removed with 0.10.0")
     ...
     */
    @Suppress("DEPRECATION")
    @Deprecated("Use something like ch.tutteli.atrium.core.Some instead; will be removed with 0.10.0")
