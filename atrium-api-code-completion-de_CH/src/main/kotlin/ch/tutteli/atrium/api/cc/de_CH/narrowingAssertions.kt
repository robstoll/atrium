 ...
 */
inline fun <reified T : Any> IAssertionPlantNullable<T?>.istNichtNull(noinline createAssertions: IAssertionPlant<T>.() -> Unit) {
 ...
 * @throws AssertionError Might throw an [AssertionError] if the assertion made is not correct.
 */
inline fun <reified TSub : Any> IAssertionPlant<Any>.istEin(noinline createAssertions: IAssertionPlant<TSub>.() -> Unit) {
