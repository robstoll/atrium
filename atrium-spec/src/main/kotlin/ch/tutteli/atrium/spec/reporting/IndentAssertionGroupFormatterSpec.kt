...
abstract class IndentAssertionGroupFormatterSpec(
    ...
    prefixedDescribe("fun ${IAssertionFormatter::formatGroup.name}") {
        context("${IAssertionGroup::class.simpleName} of type ${IIndentAssertionGroupType::class.simpleName}") {
            val assertions = listOf(
                BasicAssertion(AssertionVerb.ASSERT, 1, true),
                BasicAssertion(AssertionVerb.EXPECT_THROWN, 2, true)
            )
            val indentAssertionGroup = IndentAssertionGroup(assertions)
            ...
            context("in another ${IAssertionGroup::class.simpleName} of type ${IIndentAssertionGroupType::class.simpleName}") {
                ...
                val indentAssertionGroup2 = AssertionGroup(IndentAssertionGroupType, AssertionVerb.ASSERT, 10, indentAssertions)
