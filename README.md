...
[![Build Status](https://travis-ci.org/robstoll/atrium.svg?tag=v0.6.0)](https://travis-ci.org/robstoll/atrium/branches)
[![Coverage](https://codecov.io/github/robstoll/atrium/coverage.svg?tag=v0.6.0)](https://codecov.io/github/robstoll/atrium?tag=v0.6.0)
...
a [settings.xml](https://github.com/robstoll/atrium/tree/v0.6.0/misc/maven/settings.xml) 
is provided to set up the repository as well as an 
[example pom.xml](https://github.com/robstoll/atrium/tree/v0.6.0/misc/maven/example-pom.xml)
...
[atrium-cc-en_UK-robstoll](https://github.com/robstoll/atrium/tree/v0.6.0/bundles/atrium-cc-en_UK-robstoll/build.gradle)
in the following examples. It provides a pure fluent API. 
Have a look at 
[apis/differences.md](https://github.com/robstoll/atrium/tree/v0.6.0/apis/differences.md)
...
[subject](https://robstoll.github.io/atrium/0.6.0/doc/ch.tutteli.atrium.creating/-base-assertion-plant/subject.html).
...
Have a look at the [KDoc of the CharSequence contains Builders](https://robstoll.github.io/atrium/0.6.0/doc/ch.tutteli.atrium.api.cc.de_-c-h.assertions.charsequence.contains.builders/index.html)
to see more options.
...
[Only Failure Reporter](https://robstoll.github.io/atrium/0.6.0/doc/ch.tutteli.atrium/-i-atrium-factory/new-only-failure-reporter.html) 
...
Have a look at the 
[specifications](https://github.com/robstoll/atrium/tree/v0.6.0/atrium-spec/src/main/kotlin/ch/tutteli/atrium/spec) 
for more examples above.

Have a look at [apis/differences.md](https://github.com/robstoll/atrium/tree/v0.6.0/apis/differences.md) for a few more examples.
...
The method [createAndAddAssertion](https://robstoll.github.io/atrium/0.6.0/doc/ch.tutteli.atrium.creating/-assertion-plant/create-and-add-assertion.html) expects:
- a [Translatable](https://robstoll.github.io/atrium/0.6.0/doc/ch.tutteli.atrium.reporting.translating/-translatable/index.html)
...
```
We are using a [RawString](https://robstoll.github.io/atrium/0.6.0/doc/ch.tutteli.atrium.reporting/-raw-string/index.html)
...
[ch.tutteli.atrium.assertions.iterable.contains](https://github.com/robstoll/atrium/tree/v0.6.0/atrium-assertions/src/main/kotlin/ch/tutteli/atrium/assertions/iterable/contains).
...
[atriumVerbs.kt](https://github.com/robstoll/atrium/tree/v0.6.0/atrium-assertions/src/test/kotlin/ch/tutteli/atrium/atriumVerbs.kt)
...
Have a look at [atriumVerbs.kt of atrium-api-cc-de_CH](https://github.com/robstoll/atrium/tree/v0.6.0/apis/atrium-api-cc-de_CH/src/test/kotlin/ch/tutteli/atrium/atriumVerbs.kt)
...
maven:  
Have a look at the [example pom.xml](https://github.com/robstoll/atrium/tree/v0.6.0/misc/maven/example-pom.xml).    
...
[atrium-cc-de_CH-robstoll](https://github.com/robstoll/atrium/tree/v0.6.0/bundles/atrium-cc-de_CH-robstoll/build.gradle)
uses `atrium-translations-de_CH`.  

But you can also use a 
[TranslationSupplier](https://robstoll.github.io/atrium/0.6.0/doc/ch.tutteli.atrium.reporting.translating/-translation-supplier/index.html)
based [Translator](https://robstoll.github.io/atrium/0.6.0/doc/ch.tutteli.atrium.reporting.translating/-translator/index.html)
...
For further technical information have a look at the KDoc of [Translator](https://robstoll.github.io/atrium/0.6.0/doc/ch.tutteli.atrium.reporting.translating/-translator/index.html).
...
Atrium is 
[built up by different modules](https://robstoll.github.io/atrium/0.6.0/doc/) 
...
- [atrium-cc-en_UK-robstoll](https://github.com/robstoll/atrium/tree/v0.6.0/bundles/atrium-cc-en_UK-robstoll/build.gradle)
- [atrium-cc-de_CH-robstoll](https://github.com/robstoll/atrium/tree/v0.6.0/bundles/atrium-cc-de_CH-robstoll/build.gradle)
- [atrium-cc-infix-en_UK-robstoll](https://github.com/robstoll/atrium/tree/v0.6.0/bundles/atrium-cc-infix-en_UK-robstoll/build.gradle)
...
[CONTRIBUTING.md](https://github.com/robstoll/atrium/tree/v0.6.0/.github/CONTRIBUTING.md)
