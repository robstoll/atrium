...
◆ is instance of type: IllegalStateException (java.lang.IllegalStateException)
  » Properties of the unexpected IllegalArgumentException
    ...
    » stacktrace: 
      ...
      ⚬ readme.examples.ReadmeSpec$1$4.invoke(ReadmeSpec.kt:631)
...
```
↑ <sub>[Example](https://github.com/robstoll/atrium/tree/master/samples/readme-examples/src/main/kotlin/readme/examples/ReadmeSpec.kt#L132)</sub> ↓ <sub>Output</sub>
```text
expect: Person(firstName=Robert, lastName=Stoll, isStudent=false)        (readme.examples.ReadmeSpec$1$Person <1234789>)
...
expect(myFamily)
    ...
    .toBe("Peter")
```
↑ <sub>[Example](https://github.com/robstoll/atrium/tree/master/samples/readme-examples/src/main/kotlin/readme/examples/ReadmeSpec.kt#L149)</sub> ↓ <sub>Output</sub>
```text
...
```
↑ <sub>[Example](https://github.com/robstoll/atrium/tree/master/samples/readme-examples/src/main/kotlin/readme/examples/ReadmeSpec.kt#L165)</sub> ↓ <sub>Output</sub>
```text
...
expect(x).isA<SubType1>()
    ...
    .toBe(2)
```
↑ <sub>[Example](https://github.com/robstoll/atrium/tree/master/samples/readme-examples/src/main/kotlin/readme/examples/ReadmeSpec.kt#L198)</sub> ↓ <sub>Output</sub>
```text
...
```
↑ <sub>[Example](https://github.com/robstoll/atrium/tree/master/samples/readme-examples/src/main/kotlin/readme/examples/ReadmeSpec.kt#L204)</sub> ↓ <sub>Output</sub>
```text
expect: SubType2(word=hello, flag=true)        (readme.examples.SubType2 <1234789>)
◆ ▶ word: "hello"        <1234789>
...
```
↑ <sub>[Example](https://github.com/robstoll/atrium/tree/master/samples/readme-examples/src/main/kotlin/readme/examples/ReadmeSpec.kt#L230)</sub> ↓ <sub>Output</sub>
```text
...
expect(slogan2)     // subject has type String?
    ...
    .startsWith("atrium")
```
↑ <sub>[Example](https://github.com/robstoll/atrium/tree/master/samples/readme-examples/src/main/kotlin/readme/examples/ReadmeSpec.kt#L239)</sub> ↓ <sub>Output</sub>
```text
expect: null
◆ is instance of type: String (kotlin.String) -- Class: String (java.lang.String)
```
...
```
↑ <sub>[Example](https://github.com/robstoll/atrium/tree/master/samples/readme-examples/src/main/kotlin/readme/examples/ReadmeSpec.kt#L244)</sub> ↓ <sub>Output</sub>
```text
expect: null
◆ is instance of type: String (kotlin.String) -- Class: String (java.lang.String)
...
```
↑ <sub>[Example](https://github.com/robstoll/atrium/tree/master/samples/readme-examples/src/main/kotlin/readme/examples/ReadmeSpec.kt#L259)</sub> ↓ <sub>Output</sub>
```text
...
```
↑ <sub>[Example](https://github.com/robstoll/atrium/tree/master/samples/readme-examples/src/main/kotlin/readme/examples/ReadmeSpec.kt#L262)</sub> ↓ <sub>Output</sub>
```text
expect: [1, 2, 3, 4]        (java.util.Arrays.ArrayList <1234789>)
◆ does not contain: 
  ⚬ an entry which: 
...
```
↑ <sub>[Example](https://github.com/robstoll/atrium/tree/master/samples/readme-examples/src/main/kotlin/readme/examples/ReadmeSpec.kt#L265)</sub> ↓ <sub>Output</sub>
```text
expect: [1, 2, 3, 4]        (java.util.Arrays.ArrayList <1234789>)
◆ all entries: 
    » is greater than: 2        (kotlin.Int <1234789>)
...
```
↑ <sub>[Example](https://github.com/robstoll/atrium/tree/master/samples/readme-examples/src/main/kotlin/readme/examples/ReadmeSpec.kt#L272)</sub> ↓ <sub>Output</sub>
```text
expect: [1, 2, 2, 4]        (java.util.Arrays.ArrayList <1234789>)
◆ contains only, in order: 
  ✔ ▶ entry 0: 1        (kotlin.Int <1234789>)
...
```
↑ <sub>[Example](https://github.com/robstoll/atrium/tree/master/samples/readme-examples/src/main/kotlin/readme/examples/ReadmeSpec.kt#L275)</sub> ↓ <sub>Output</sub>
```text
expect: [1, 2, 2, 4]        (java.util.Arrays.ArrayList <1234789>)
◆ contains, in any order: 
  ⚬ an entry which: 
...
```
↑ <sub>[Example](https://github.com/robstoll/atrium/tree/master/samples/readme-examples/src/main/kotlin/readme/examples/ReadmeSpec.kt#L278)</sub> ↓ <sub>Output</sub>
```text
expect: [1, 2, 2, 4]        (java.util.Arrays.ArrayList <1234789>)
...
```
↑ <sub>[Example](https://github.com/robstoll/atrium/tree/master/samples/readme-examples/src/main/kotlin/readme/examples/ReadmeSpec.kt#L281)</sub> ↓ <sub>Output</sub>
```text
expect: [1, 2, 2, 4]        (java.util.Arrays.ArrayList <1234789>)
◆ contains only, in any order: 
  ✔ an entry which is: 4        (kotlin.Int <1234789>)
...
```
↑ <sub>[Example](https://github.com/robstoll/atrium/tree/master/samples/readme-examples/src/main/kotlin/readme/examples/ReadmeSpec.kt#L288)</sub> ↓ <sub>Output</sub>
```text
expect: {a=1, b=2}        (java.util.LinkedHashMap <1234789>)
◆ contains, in any order: 
  ⚬ ▶ entry "c": ❗❗ key does not exist
...
```
↑ <sub>[Example](https://github.com/robstoll/atrium/tree/master/samples/readme-examples/src/main/kotlin/readme/examples/ReadmeSpec.kt#L300)</sub> ↓ <sub>Output</sub>
```text
...
```
↑ <sub>[Example](https://github.com/robstoll/atrium/tree/master/samples/readme-examples/src/main/kotlin/readme/examples/ReadmeSpec.kt#L312)</sub> ↓ <sub>Output</sub>
```text
expect: {a=1, b=2}        (java.util.LinkedHashMap <1234789>)
...
```
↑ <sub>[Example](https://github.com/robstoll/atrium/tree/master/samples/readme-examples/src/main/kotlin/readme/examples/ReadmeSpec.kt#L318)</sub> ↓ <sub>Output</sub>
```text
expect: {a=1, b=2}        (java.util.LinkedHashMap <1234789>)
◆ contains only, in order: 
...
```
↑ <sub>[Example](https://github.com/robstoll/atrium/tree/master/samples/readme-examples/src/main/kotlin/readme/examples/ReadmeSpec.kt#L328)</sub> ↓ <sub>Output</sub>
```text
...
```
↑ <sub>[Example](https://github.com/robstoll/atrium/tree/master/samples/readme-examples/src/main/kotlin/readme/examples/ReadmeSpec.kt#L337)</sub> ↓ <sub>Output</sub>
```text
...
```
↑ <sub>[Example](https://github.com/robstoll/atrium/tree/master/samples/readme-examples/src/main/kotlin/readme/examples/ReadmeSpec.kt#L350)</sub> ↓ <sub>Output</sub>
```text
...
```
↑ <sub>[Example](https://github.com/robstoll/atrium/tree/master/samples/readme-examples/src/main/kotlin/readme/examples/ReadmeSpec.kt#L364)</sub> ↓ <sub>Output</sub>
```text
expect: "calling myFun with ..."        <1234789>
◆ ▶ myFun(3): 'd'
    ◾ is greater than: 'e'
...
```
↑ <sub>[Example](https://github.com/robstoll/atrium/tree/master/samples/readme-examples/src/main/kotlin/readme/examples/ReadmeSpec.kt#L382)</sub> ↓ <sub>Output</sub>
```text
...
```
↑ <sub>[Example](https://github.com/robstoll/atrium/tree/master/samples/readme-examples/src/main/kotlin/readme/examples/ReadmeSpec.kt#L406)</sub> ↓ <sub>Output</sub>
```text
expect the thrown exception: java.lang.IllegalArgumentException
◆ is instance of type: IllegalStateException (java.lang.IllegalStateException)
  ...
  » Properties of the unexpected IllegalArgumentException
    ...
    » stacktrace: 
      ⚬ readme.examples.ReadmeSpec2$1$31$1.invoke(ReadmeSpec.kt:411)
      ⚬ readme.examples.ReadmeSpec2$1$31$1.invoke(ReadmeSpec.kt:223)
      ⚬ readme.examples.ReadmeSpec2$1$31.invoke(ReadmeSpec.kt:631)
      ⚬ readme.examples.ReadmeSpec2$1$31.invoke(ReadmeSpec.kt:223)
...
```
↑ <sub>[Example](https://github.com/robstoll/atrium/tree/master/samples/readme-examples/src/main/kotlin/readme/examples/ReadmeSpec.kt#L416)</sub> ↓ <sub>Output</sub>
```text
...
```
↑ <sub>[Example](https://github.com/robstoll/atrium/tree/master/samples/readme-examples/src/main/kotlin/readme/examples/ReadmeSpec.kt#L419)</sub> ↓ <sub>Output</sub>
```text
...
```
↑ <sub>[Example](https://github.com/robstoll/atrium/tree/master/samples/readme-examples/src/main/kotlin/readme/examples/ReadmeSpec.kt#L431)</sub> ↓ <sub>Output</sub>
```text
...
expect(13).isEven()
```
↑ <sub>[Example](https://github.com/robstoll/atrium/tree/master/samples/readme-examples/src/main/kotlin/readme/examples/ReadmeSpec.kt#L442)</sub> ↓ <sub>Output</sub>
```text
...
```
↑ <sub>[Example](https://github.com/robstoll/atrium/tree/master/samples/readme-examples/src/main/kotlin/readme/examples/ReadmeSpec.kt#L481)</sub> ↓ <sub>Output</sub>
```text
...
expect(Person("Susanne", "Whitley", 43, listOf()))
    .hasAdultChildren()
```
↑ <sub>[Example](https://github.com/robstoll/atrium/tree/master/samples/readme-examples/src/main/kotlin/readme/examples/ReadmeSpec.kt#L496)</sub> ↓ <sub>Output</sub>
```text
expect: Person(firstName=Susanne, lastName=Whitley, age=43, children=[])        (readme.examples.Person <1234789>)
◆ ▶ children: []        (kotlin.collections.EmptyList <1234789>)
...
expect(Person("Susanne", "Whitley", 43, listOf(Person("Petra", "Whitley", 12, listOf()))))
    ...
    .hasSize(2)
```
↑ <sub>[Example](https://github.com/robstoll/atrium/tree/master/samples/readme-examples/src/main/kotlin/readme/examples/ReadmeSpec.kt#L506)</sub> ↓ <sub>Output</sub>
```text
