...
abstract class AbstractCharSequenceToContainAtLeastExpectationsTest(
    ...
    fun toContainAtLeast__happy_case_with_toContainAtLeast_once() =
        testFactory(toContainAtLeastSpec) { toContainAtLeastFun ->
            it("${toContainAtLeastPair.first("'H'", "once")} does not throw") {
                ch.tutteli.atrium.api.verbs.internal.expect(helloWorld).toContainAtLeastFun(1, 'H')
            }
            it("${toContainAtLeastPair.first("'H' and 'e' and 'W'", "once")} does not throw") {
                ch.tutteli.atrium.api.verbs.internal.expect(helloWorld).toContainAtLeastFun(1, 'H', 'e', 'W')
            }
            it("${toContainAtLeastPair.first("'W' and 'H' and 'e'", "once")} does not throw") {
                ch.tutteli.atrium.api.verbs.internal.expect(helloWorld).toContainAtLeastFun(1, 'W', 'H', 'e')
            }
        }
    ...
    fun toContainAtLeastIgnoringCase__subject_failing_cases__search_string_at_different_positions() =
        testFactory(toContainAtLeastIgnoringCaseSpec) { toContainAtLeastIgnoringCaseFun ->
            it("${toContainAtLeastIgnoringCasePair.first("'h'", "once")} does not throw") {
                ch.tutteli.atrium.api.verbs.internal.expect(helloWorld).toContainAtLeastIgnoringCaseFun(1, 'h')
            }


            it("${toContainAtLeastIgnoringCasePair.first("'H', 'E'", "once")} does not throw") {
                ch.tutteli.atrium.api.verbs.internal.expect(helloWorld).toContainAtLeastIgnoringCaseFun(1, 'H', 'E')
            }


            it("${toContainAtLeastIgnoringCasePair.first("'E', 'H'", "once")} does not throw") {
                ch.tutteli.atrium.api.verbs.internal.expect(helloWorld).toContainAtLeastIgnoringCaseFun(1, 'E', 'H')
            }


            it("${toContainAtLeastIgnoringCasePair.first("'H', 'E', 'w' and 'r'", "once")} does not throw") {
                ch.tutteli.atrium.api.verbs.internal.expect(helloWorld)
    ...
    fun toContainAtLeast__multiple_occurrences_of_the_search_string() =
        testFactory(toContainAtLeastSpec) { toContainAtLeastFun ->
            it("${toContainAtLeastPair.first("'o'", "once")} does not throw") {
                ch.tutteli.atrium.api.verbs.internal.expect(helloWorld).toContainAtLeastFun(1, 'o')
            }
            it("${toContainAtLeastPair.first("'o'", "twice")} does not throw") {
                ch.tutteli.atrium.api.verbs.internal.expect(helloWorld).toContainAtLeastFun(2, 'o')
            }
            it(
            ...
            it("${toContainAtLeastPair.first("'o' and 'l'", "twice")} does not throw") {
                ch.tutteli.atrium.api.verbs.internal.expect(helloWorld).toContainAtLeastFun(2, 'o', 'l')
            }
            it("${toContainAtLeastPair.first("'l'", "3 times")} does not throw") {
                ch.tutteli.atrium.api.verbs.internal.expect(helloWorld).toContainAtLeastFun(3, 'l')
            }
            it(
    ...
    fun toContainAtLeastIgnoringCase__multiple_occurrences_of_the_search_string() =
        testFactory(toContainAtLeastIgnoringCaseSpec) { toContainAtLeastIgnoringCaseFun ->
            it("${toContainAtLeastIgnoringCasePair.first("'o'", "3 times")} does not throw") {
                ch.tutteli.atrium.api.verbs.internal.expect(helloWorld).toContainAtLeastIgnoringCaseFun(3, 'o')
            }
            it("${toContainAtLeastIgnoringCasePair.first("'o' and 'l'", "3 times")} does not throw") {
                ch.tutteli.atrium.api.verbs.internal.expect(helloWorld).toContainAtLeastIgnoringCaseFun(3, 'o', 'l')
            }
        }
    ...
    fun toContainAtLeastButAtMost() = testFactory(toContainAtLeastButAtMostSpec) { toContainAtLeastButAtMostFun ->
        it("${toContainAtLeastButAtMostPair.first("'o'", "once", "twice")} does not throw") {
            ch.tutteli.atrium.api.verbs.internal.expect(helloWorld).toContainAtLeastButAtMostFun(1, 2, 'o')
        }
        it(
