...
abstract class AbstractCharSequenceToContainAtMostExpectationsTest(
    ...
    @TestFactory
    fun toContainAtMost__subject_throws_an_IllegalArgumentException() = testFactory(toContainAtMostSpec) { toContainAtMostFun ->
    ...
    @TestFactory
    fun toContainAtMost__subject_happy_case_with_toContainAtMost_twice() = testFactory(toContainAtMostSpec) { toContainAtMostFun ->}
    ...
    @TestFactory
    fun toContainAtMost__subject_failing_cases__search_string_at_different_positions() = testFactory(toContainAtMostSpec) { toContainAtMostFun ->
    ...
    @TestFactory
    fun toContainAtMostIgnoringCase__subject_failing_cases__search_string_at_different_positions() = testFactory(toContainAtMostIgnoringCaseSpec) { toContainAtMostIgnoringCaseFun ->
        it(
    ...
    @TestFactory
    fun toContainAtMost__multiple_occurrences_of_the_search_string() = testFactory(toContainAtMostSpec) { toContainAtMostFun ->
    ...
    @TestFactory
    fun toContainAtMostIgnoringCase__multiple_occurrences_of_the_search_string() = testFactory(toContainAtMostIgnoringCaseSpec) { toContainAtMostIgnoringCaseFun ->
        it(
