...
abstract class FeatureAssertionsSpec(
    ...
    val assert: (TestData) -> Assert<TestData> = verbs::checkImmediately
    ...
    val nullableHoldsFunctions = arrayOf(
        ...
        "`returnValueOf` with 1 argument and notToBeNull" to return1ValueNullableHolds,
        "`returnValueOf` without argument and notToBeNull" to return0ValueNullableHolds,
        "`returnValueOf` with 2 arguments and notToBeNull" to return2ValueNullableHolds,
        "`returnValueOf` with 3 arguments and notToBeNull" to return3ValueNullableHolds,
        "`returnValueOf` with 4 arguments and notToBeNull" to return4ValueNullableHolds,
        "`returnValueOf` with 5 arguments and notToBeNull" to return5ValueNullableHolds
    )
