...
abstract class IterableContainsInAnyOrderAtLeast1EntriesAssertionsSpec(
    ...
    val (containsInAnyOrderEntries, containsInAnyOrderEntriesFunArr) = containsInAnyOrderEntriesPair
    ...
    group("$describePrefix describe non-nullable cases") {
        mapOf<String, Assert<Iterable<Double>>.(Assert<Double>.() -> Unit, Array<out Assert<Double>.() -> Unit>) -> Any>(
            containsInAnyOrderEntries to { a, aX -> this.containsInAnyOrderEntriesFunArr(a, aX) },
            containsInAnyOrderNullableEntries to { a, aX -> this.containsInAnyOrderNullableEntriesFunArr(a, aX) }
