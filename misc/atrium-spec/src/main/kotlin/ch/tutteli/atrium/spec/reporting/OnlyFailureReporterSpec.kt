...
abstract class OnlyFailureReporterSpec(
    ...
    describeFun(testee::format.name) {
        ...
        val assertionGroup = AssertImpl.builder.root.create(AssertionVerb.VERB, 1, listOf(assertion, basicAssertion, basicAssertionAnonymous, assertionGroupAnonymous))
