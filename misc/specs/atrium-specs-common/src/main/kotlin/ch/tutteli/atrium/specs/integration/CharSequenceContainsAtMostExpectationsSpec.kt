...
abstract class CharSequenceContainsAtMostExpectationsSpec(
    ...
    describeFun(containsAtMost.name, containsAtMostIgnoringCase.name) {
        ...
        context("text '$helloWorld'") {
            ...
            context("multiple occurrences of the search string") {
                ...
                it(
                    "${containsAtMostIgnoringCasePair.first("'o'", "twice")} throws AssertionError " +
                ...
                it(
                    "${containsAtMostPair.first("'o' and 'l'", "twice")} throws AssertionError " +
