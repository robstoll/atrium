...
abstract class CharSequenceContainsRegexAssertionsSpecString(
...
abstract class CharSequenceContainsRegexAssertionsSpecRegex(
    containsRegex: String,
    containsAtLeastPair: Pair<(Regex, String) -> String, Fun3<CharSequence, Int, String, Array<out String>>>,
    containsAtLeastIgnoringCasePair: Pair<(Regex, String) -> String, Fun3<CharSequence, Int, String, Array<out String>>>,
    //TODO usually the shortcut is tested individually on a level lower and not expected as we did it here (search for ShortcutSpec or similar)
    containsShortcutPair: Pair<(Regex, String) -> String, Fun2<CharSequence, String, Array<out String>>>,
    containsAtMostPair: Pair<(Regex, String) -> String, Fun3<CharSequence, Int, String, Array<out String>>>,
    containsAtMostIgnoringCasePair: Pair<(Regex, String) -> String, Fun3<CharSequence, Int, String, Array<out String>>>,
    rootBulletPoint: String,
    listBulletPoint: String,
    describePrefix: String = "[Atrium] "
) : CharSequenceContainsSpecBase({
    ...
    describeFun(containsRegex) {
        ...
        context("text $text") {
            it("${containsAtLeastPair.first(Regex("'$hello'"), "once")} does not throw") {
                fluent.containsAtLeastFun(1, hello)
            }
            it("${containsAtLeastPair.first(Regex("'$hello', '$hello' and '$hello'"), "once")} does not throw") {
                fluent.containsAtLeastFun(1, hello, hello, hello)
            }
            it("${containsAtLeastPair.first(Regex("'$hello' and '$roberto'"), "once")} does not throw") {
                fluent.containsAtLeastFun(1, hello, roberto)
            }
            it("${containsAtLeastPair.first(Regex("'${roberto.toLowerCase()}'"), "once")} throws AssertionError") {
                expect {
                    fluent.containsAtLeastFun(1, roberto.toLowerCase())
                }.toThrow<AssertionError> {
                    message {
            ...
            it("${containsAtLeastIgnoringCasePair.first(Regex("'${roberto.toLowerCase()}'"), "once")} does not throw") {
                fluent.containsAtLeastIgnoringCaseFun(1, roberto.toLowerCase())
            }

            it("${containsShortcutPair.first(Regex("'$hello'"), "once")} does not throw") {
                fluent.containsShortcutFun(hello)
            }
            it("${containsShortcutPair.first(Regex("'$hello', '$hello' and '$hello'"), "once")} does not throw") {
                fluent.containsShortcutFun(hello, hello, hello)
            }
            it("${containsShortcutPair.first(Regex("'$hello' and '$roberto'"), "once")} does not throw") {
                fluent.containsShortcutFun(hello, roberto)
            }

            it("${containsAtMostPair.first(Regex("'[a-z]'"), "17 times")} does not throw") {
                fluent.containsAtMostFun(17, "[a-z]")
            }
            it("${containsAtMostIgnoringCasePair.first(Regex("'[a-z]'"), "19 times")} does not throw") {
                fluent.containsAtMostIgnoringCaseFun(19, "[a-z]")
            }
            it("${containsAtMostIgnoringCasePair.first(Regex("'[a-z]' and '[A-Z]'"), "19 times")} does not throw") {
                fluent.containsAtMostIgnoringCaseFun(19, "[a-z]", "[A-Z]")
            }

            it("${containsAtMostPair.first(Regex("'[a-z]'"), "16 times")} throws AssertionError") {
                expect {
                    fluent.containsAtMostFun(16, "[a-z]")
                }.toThrow<AssertionError> {
                    message {
            ...
            it("${containsAtMostIgnoringCasePair.first(Regex("'[a-z]'"), "18 times")} throws AssertionError") {
                expect {
                    fluent.containsAtMostIgnoringCaseFun(18, "[a-z]")
                }.toThrow<AssertionError> {
                    message {
