 ...
 *
 * It is similar to [FeatureExpectations] but differs in the intended usage.
 * [FeatureExpectations] are intended to make assertions about a return value of a method call or a property,
