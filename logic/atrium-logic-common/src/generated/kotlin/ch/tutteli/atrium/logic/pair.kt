...
import ch.tutteli.atrium.logic.impl.DefaultPairExpectations
...
private inline val <T> AssertionContainer<T>.impl: PairExpectations
    get() = getImpl(PairExpectations::class) { DefaultPairExpectations() }
