...
import ch.tutteli.atrium.logic.impl.DefaultMapLikeExpectations
...
private inline val <T> AssertionContainer<T>.impl: MapLikeExpectations
    get() = getImpl(MapLikeExpectations::class) { DefaultMapLikeExpectations() }
