...
class FeatureAssertionsBuilderNameRepresentationSpec : ch.tutteli.atrium.spec.integration.FeatureAssertionsSpec(
    ...
    companion object {
        ...
        val propertyImmediate: F = { property(this, { subject.description }, representationProvider, "description").contains("hello") }
        val propertyLazy: F = { property(this, { subject.description }, representationProvider, "description") { contains("hello") } }
        ...
        val propertyNullableDoesNotHold: F = { val l = { subject.nullableValue }; property(this, l, representationProvider, "nullableValue").toBe(null) }
        ...
        //TODO get rid of l if https://youtrack.jetbrains.com/issue/KT-23768 is fixed
        val propertyNullableHolds: F = { val l = { subject.nullableValue }; property(this, l, representationProvider, "nullableValue").notToBeNull {} }
        ...
        val propertyLazyWithNestedImmediate: F = {
            property(this, { subject.description }, representationProvider, "description") {
