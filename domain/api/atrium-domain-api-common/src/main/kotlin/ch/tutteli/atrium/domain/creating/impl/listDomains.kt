...
import ch.tutteli.atrium.domain.creating.ListOnlyDomain
...
internal class ListDomainImpl<E, T : List<E>>(
    ListOnlyDomain: ListOnlyDomain<E, T>,
    collectionDomain: CollectionDomain<E, T>
) : ListDomain<E, T>, ListOnlyDomain<E, T> by ListOnlyDomain, CollectionDomain<E, T> by collectionDomain {
    override val expect: Expect<T> = ListOnlyDomain.expect
}

internal class ListOnlyDomainImpl<E, T : List<E>>(
