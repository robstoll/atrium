...
fun <T : Path> _fileName(assertionContainer: Expect<T>): ExtractedFeaturePostStep<T, Path> =
    ExpectImpl.feature.manualFeature(assertionContainer, DescriptionPathAssertion.FILE_NAME) { fileName }
