...
fun <T : ChronoLocalDate> _isBefore(assertionContainer: Expect<T>, expected: ChronoLocalDate): Assertion =
    ExpectImpl.builder.createDescriptive(assertionContainer, IS_BEFORE, expected) { it.isBefore(expected) }

fun <T : ChronoLocalDate> _isBeforeOrEquals(assertionContainer: Expect<T>, expected: ChronoLocalDate): Assertion =
...
fun <T : ChronoLocalDate> _isAfter(assertionContainer: Expect<T>, expected: ChronoLocalDate): Assertion =
